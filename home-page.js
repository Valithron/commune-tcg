(function(){
  ...
  function simpleCard(c,i){
    var cc=chHome(c.cid),img=c.img?'<img src="'+esc(c.img)+'" style="'+(typeof cropStyle==='function'?cropStyle(c):'')+'">':'<div class="homeMiniPh">'+esc(cc.in)+'</div>';
