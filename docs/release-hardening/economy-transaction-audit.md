...
- Maximum: 10.
- Regeneration: 1 per completed 7-minute interval, superseding the initial 30-minute test value by Sterling's explicit production-hotfix approval on 2026-07-11.
- Empty to full: 70 minutes.
...
- Modifiers: no Gold, ticket, reward, purchase, mission, card, level, item, boost, passive system, or gameplay modifier shortens 7 minutes.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TX-01 | Sterling fixture | Energy 2, timestamp +6:59 | Read/reconcile | 0 Energy | 0 | N/A | N/A | Energy 2, timestamp retained | Same | Energy test |
| TX-02 | Sterling fixture | Energy 2, timestamp +7:00 | Read/reconcile | +1 Energy | +1 | N/A | N/A | Energy 3 | No duplicate | Energy test |
| TX-03 | Sterling fixture | Energy 3, 95 minutes elapsed | Read/reconcile | +3, retain 5 minutes | +3 | N/A | N/A | Energy 6, timestamp +90 minutes | No duplicate | Energy test |
...
| TX-06 | Sterling fixture | Energy 0, 40 minutes elapsed | Begin 1-Energy battle | +1 then -1 | 0 net | Pending attempt 1 | 0 | Energy 0; 10-minute partial retained | Attempt ID idempotent | Battle backend test |
...
- Exact Energy recharge boundary against D1.
