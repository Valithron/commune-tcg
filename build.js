...
const files = ['index.html', 'app.css', 'app.js', 'ux-refresh-guard.js', 'crop-touch.css', 'crop-touch.js', 'title-limit.js', 'battle-end.js', 'mint-upload-enhance.js', 'mint-flavor.js', 'mint-success-redirect.js', 'ai-battle-squad.js', 'ai-enemy-type.js', 'market-sparklines.js', 'market-smooth-refresh.js', 'battle-history.js', 'card-xp.js', 'battle-rules.js', 'battle-flow.js', 'battle-team-fix.js', 'battle-fullscreen.js', 'battle-no-flavor.js', 'battle-ko-fix.js', 'battle-results-polish.js', 'battle-setup-fix.js', 'ascension-ceremony.js', 'ascension-mobile-click-fix.js', 'ascension-failsafe.js', 'mobile-collection-fix.js', 'vaults.js', 'card-polish-fix.js', 'no-sidebar-pages.js', 'collection-desktop-layout.css', 'collection-mobile.css', 'ticker-fix.css', '_headers', '_redirects'];
