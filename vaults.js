...
function vaultsRaritySections(cards,v){
  return ['legendary','rare','uncommon','common'].map(r=>vaultsRaritySection(r,cards.filter(x=>x.rar===r),v));
}
