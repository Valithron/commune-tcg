...
export function renderResourceInventory() {
  ...
  return `
    <section class="hero-panel">
      ...
      <p class="hero-copy">Phase 10.3 resolves live Sterling pulls.</p>
    ...
    <section class="glass-panel backend-panel">
      ...
      <h2 class="section-title">Verify live pull</h2>
      <div class="admin-checklist">
        <div>Use Pull Chamber confirmation.</div>
        <div>Confirm Source shows Real Pull.</div>
        <div>Confirm tickets decrease.</div>
        <div>Confirm new cards appear in Sterling Vault.</div>
