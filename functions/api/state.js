...
async function ensureMarketHistory(env){
  await env.DB.prepare('CREATE TABLE IF NOT EXISTS market_price_history (id INTEGER PRIMARY KEY, token_type TEXT NOT NULL, price REAL NOT NULL, source TEXT NOT NULL DEFAULT "drift", created_at TEXT DEFAULT CURRENT_TIMESTAMP)').run();
