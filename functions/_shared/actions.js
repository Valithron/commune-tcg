...
export function makeCard(o={}){let cid=CHARACTER_IDS.includes(o.cid)?o.cid:'cydney',rar=R[o.rar]?o.rar:rarity(),r=R[rar],p=rnd(r[3],r[4]),d=rnd(r[3],r[4]),s=rnd(r[3],r[4]),passive=rnd(r[5],r[6]);return{id:crypto.randomUUID(),owner:o.owner||null,cid,title:String(o.title||title(cid)).slice(0,25),tag:String(o.tag||'Battle').slice(0,40),rar,p,d,s,passive,effect:E[cid],grade:p+d+s+(rar==='legendary'?80:rar==='rare'?35:rar==='uncommon'?12:0),img:o.img||null,imageKey:o.imageKey||null,crop:o.crop||{x:50,y:50,z:1},equipped:false}}
