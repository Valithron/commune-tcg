...
function buildOwnedCardPayload({ baseCard, ownedCardId, pullId, now }) {
  ...
  const ownedStatProfile = rollOwnedCopyStatProfile({
    ...
    source: {
      ...baseCard,
      cardType: baseCard.cardType || baseCard.card_type || baseCard.type || 'neutral',
      statArchetype: baseCard.statArchetype || baseCard.stat_archetype || baseCard.type || 'neutral',
    },
  });
  ...
  return {
    ...
    type: ownedStatProfile.cardType,
    cardType: ownedStatProfile.cardType,
    card_type: ownedStatProfile.cardType,
